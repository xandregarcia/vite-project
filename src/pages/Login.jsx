  ...
  return (
    <>
      <Wrapper>
        ...
        {/* 
        <div className="container min-h-screen flex items-center justify-center page bg-slate-200 shadow-md rounded-md bg-opacity-50">
          <main className=" px-6 md:px-16 my-auto ">
            <div className="w-full max-w-sm mx-auto p-16 px-12 bg-white ">
              <div className="flex flex-nowrap items-center justify-center">
                ...
                <h1 className="text-left">
                  ...
                  <p className="text-md font-semibold">Scheduling System</p>
                </h1>
              </div>
            </div>
          </main>
